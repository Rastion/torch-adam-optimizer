...
class TorchAdamOptimizer(BaseOptimizer):
    ...
    def optimize(self, problem, **kwargs):
        ...
        Additional keyword arguments (e.g., "cost_function") must be provided.
        ...
        for step in range(self.max_steps):
            ...
            # (Assumes cost_function takes a NumPy array as input.)
            cost = cost_function(theta.detach().numpy())
            # Convert cost to a torch tensor for backpropagation.
